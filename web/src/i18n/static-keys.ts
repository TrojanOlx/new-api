...
export const STATIC_I18N_KEYS = [
  ...
  // Administrator user access-control enums (passed to t at runtime)
  'Unrestricted',
  'Allowlist',
  'Off',
  'Observe',
  ...
  'trust',
  'block',
  'Add at least one IP address or CIDR',
  'Enter no more than 64 IP addresses or CIDRs',
  'Enter a valid IPv4, IPv6, or CIDR on each line',
  'Failed to verify trusted devices',
