...
func main() {
	...
	if err := service.ShutdownDeviceAccessStats(); err != nil {
		common.SysError(fmt.Sprintf("failed to flush device access statistics during shutdown: %v", err))
	}
...
func InitResources() error {
	...
	service.StartDeviceAccessStats()
