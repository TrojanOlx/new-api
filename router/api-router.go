	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/access-policy", controller.GetUserAccessPolicy)
				adminRoute.PATCH("/:id/access-policy", controller.UpdateUserAccessPolicy)
				adminRoute.GET("/:id/devices", controller.ListUserDevices)
				adminRoute.GET("/:id/devices/:device_id", controller.GetUserDevice)
				adminRoute.PATCH("/:id/devices/:device_id", controller.UpdateUserDevice)
				adminRoute.PATCH("/:id/devices/:device_id/fingerprints/:fingerprint_id", controller.UpdateUserDeviceFingerprint)
